...
public class PlayerHealth : MonoBehaviourPunCallbacks, IPunObservable {
    ...
    void Update() {
        ...
        if (PhotonNetwork.CurrentRoom.PlayerCount == netManager.maxPLayer && netManager.isGameStart == false)
        {
            if (!netManager.isGameFinish)
            {
    ...
    public void TakeDamage(int amount, string enemyName) {
        ...
        netManager.AddFrag(PhotonNetwork.LocalPlayer.NickName);
    }
